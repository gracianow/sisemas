package net.demoisellelab.cadastrorest.business;

import java.util.List;

import net.demoisellelab.cadastrorest.entity.Bookmark;
import net.demoisellelab.cadastrorest.persistence.BookmarkDAO;
