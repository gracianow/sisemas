package net.demoisellelab.cadastrorest.rest;
...
import net.demoisellelab.cadastrorest.entity.Pessoa;
import net.demoisellelab.cadastrorest.persistence.PessoaDAO;
...
import br.gov.frameworkdemoiselle.util.PATCH;
...
public class PessoaREST {
    ...
    public Response inserir(PessoaBody body) {
        ...
        String url = "http://localhost:8080/cadastrorest/api/pessoa/" + id;
